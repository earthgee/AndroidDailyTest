package com.earhtgee.systrace.transform
        ...
        for (input in invocation.inputs) {
            for (directoryInput in input.directoryInputs) {
                ...
                val outputDirectory = outputProvider.getContentLocation(
                    ...
                    directoryInput.scopes,
                    Format.DIRECTORY)
                Log.i(TAG, "directoryInput path:%s, outputDirectory path:%s", inputDir.absolutePath, outputDirectory.absolutePath)
            ...
            for (jarInput in input.jarInputs) {
                ...
                val outputJar = outputProvider.getContentLocation(
                    ...
                    jarInput.scopes,
                    Format.JAR)
                Log.i(TAG, "jarInput name:%s, outputDirectory path:%s", jarInput.name, outputJar.absolutePath)
